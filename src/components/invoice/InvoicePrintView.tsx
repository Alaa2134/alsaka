  ...
  return (
    <div className="bg-white text-black p-8 print:p-4" dir="rtl">
      ...
      <div className="text-center border-b-4 border-primary pb-6 mb-6">
        <h1 className="text-3xl font-bold text-primary mb-2">شركة السقا للأدوات المنزلية</h1>
        <p className="text-muted-foreground">العنوان: القاهرة - مصر</p>
        <p className="text-muted-foreground">هاتف: 01234567890</p>
      </div>

      {/* Invoice Title */}
      <div className="bg-primary text-white text-center py-3 rounded-lg mb-6">
      ...
      <div className="grid grid-cols-2 gap-6 mb-6 p-4 bg-muted/30 rounded-lg">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-semibold text-primary">{invoice.invoice_number}</span>
          </div>
          <div className="flex items-center gap-2">
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-primary text-white">
              <th className="border border-primary/50 px-3 py-2 text-right">#</th>
              <th className="border border-primary/50 px-3 py-2 text-right">رقم الصنف</th>
              <th className="border border-primary/50 px-3 py-2 text-right">اسم الصنف</th>
              <th className="border border-primary/50 px-3 py-2 text-center">الكمية</th>
              <th className="border border-primary/50 px-3 py-2 text-center">السعر</th>
              <th className="border border-primary/50 px-3 py-2 text-center">الإجمالي</th>
            </tr>
          </thead>
          <tbody>
      ...
      <div className="flex justify-end mb-6">
        <div className="w-64 space-y-2">
          ...
          <div className="flex justify-between items-center py-3 bg-primary text-white rounded-lg px-4">
