    ...
    extend: {
      ...
      colors: {
        ...
        invoice: {
          ...
          "input-field": "hsl(var(--input-field-bg))",
          time: "hsl(var(--time-display))",
          "nav-btn": "hsl(var(--button-nav))",
          "nav-btn-hover": "hsl(var(--button-nav-hover))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        elevated: "0 8px 30px -8px hsl(221 83% 53% / 0.2)",
      },
      backgroundImage: {
        "gradient-primary":
        ...
        "gradient-warning":
          "linear-gradient(135deg, hsl(38 92% 50%), hsl(28 92% 45%))",
      },
      keyframes: {
        "fade-in": {
